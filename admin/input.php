        ...
        <div class="container-fluid">
          ...
          <div class="ml-5 mr-5">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <p class="display-4 mt-4ml-5">Form Input Data</p>
            </div>
            <form action="create.php" method="post">
              ...
              <div class="input-group flex-nowrap">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="addon-wrapping">&ensp;&emsp;ID&emsp;&ensp;</span>
                </div>
              ...
              <div class="input-group flex-nowrap pt-4">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="addon-wrapping">Created&nbsp;</span>
                </div>
                <input name="create_by" type="text" class="form-control" placeholder="Masukan create-by..." aria-label="Username" aria-describedby="addon-wrapping">
              </div>

              <!--content-->
              <div class="input-group flex-nowrap pt-4">
                <textarea name="content" type="text" class="form-control" placeholder="Masukan articel..." aria-label="Username" aria-describedby="addon-wrapping"></textarea>
              </div>
          ...
          <div class="row ml-5 mr-5">
            ...
            <table id="myTable" class="table mt-4 table-hover table-responsive-sm">
              <tr>
                <th>ID</th>
                <th>Title</th>
                <th>Sub Title</th>
              ...
              <?
              $sql = mysqli_query($conn, "SELECT ID, title, sub_title,create_by, content FROM table_data_input");
              while ($p = mysqli_fetch_array($sql)) {
                ...
                <tr>
                  ...
                  <td><? echo $p['create_by']; ?></td>
                  <td><? echo $p['content']; ?></td>
                  <td>
                    <a href="ubah_data.php?id=<? echo $p['ID']; ?>">Ubah</a> |
                    <a href="hapus.php?id=<? echo $p['ID']; ?>">Hapus</a>
