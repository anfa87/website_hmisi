      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="../index.php" target="_blank">Main Website</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsetable" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="input_card.php" target="_blank">Input Data</a>
          </div>
        </div>
      </li>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex mb-0">
            <h1 class="h6 mb-3 text-gray-800"><? echo "Data yang telah di input : " . $count  . " Buah." ?></h1>
          </div>

          <div class="d-sm-flex mb-1">
            <h1 class="h6 mb-3 text-gray-800"><? echo "Data Card yang telah di input : " . $count_card  . " Buah." ?></h1>
          </div>

          <div class="d-sm-flex mb-0">
            <h1 class="h6 mb-3 text-gray-800"><? echo "Data terakhir di tambahkan Pada " . $time_data['create_date'] . " " . $time_data['create_by'] ?></h1>
          </div>
