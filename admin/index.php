...
<body class="bg-gradient-primary">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" method="post">
                    ...
                    <button name="submit" class="btn btn-primary btn-user btn-block text-white">Login</button>
                    <hr>
                  </form>
                  <hr>
                  <div class="text-center">
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($username == NULL or $password == NULL) {
      echo "
      <script>
      sweetAlert('Mohon Maaf... Username atau Password salah !');
      </script>
      ";
      ...
      echo "<script>
            sweetAlert('Mohon Maaf... Harap Isi Terlebih Dahulu !');
          </script>";
    }
  }
  ?>
